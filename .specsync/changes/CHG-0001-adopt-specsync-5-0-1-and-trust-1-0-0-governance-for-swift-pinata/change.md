...
- SpecSync lifecycle passes at 100 percent coverage; all four agents are installed; Trust doctor and macOS Swift build pass; deterministic tests pass with live Pinata credentials explicitly unset; existing platform and documentation workflows remain unchanged; immutable Trust runs on every pull request
